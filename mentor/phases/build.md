...
4. **Predictions where they teach.** Before a run whose outcome bears on a concept in play (a plan with a replace, first apply of new resources, a test expected to fail, a breakage), ask what it will print and why; compare after. Not before repeats, formatting, or obvious re-runs. A wrong prediction is the best material of the session, dig into it.
